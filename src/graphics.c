...
void drawString(char *s, int x, int y) { printf("DS %i %i @%s\n", x, y, s); }
...
void clear(void) { printf("CL\n"); }

void setWindowSize(int width, int height) {
  printf("SW %i %i\n", width, height);
}

void sleep(int time) { printf("SL %i\n", time); }

void foreground(void) { printf("FG\n"); }

void background(void) { printf("BG\n"); }